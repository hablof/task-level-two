...
/*
	Фасад объединяет объекты, реализующие необходимые методы интерфйса по частям, в один объект, выполняющий это интерфейс
*/

// Проблема: нужна структура реализующая интерфейс
